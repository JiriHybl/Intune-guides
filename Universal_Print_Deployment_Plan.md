...
- Print jobs are encrypted in transit with TLS 1.2 or TLS 1.3. Queued jobs are stored temporarily in Microsoft 365/Office storage for up to 10 days from submission and may remain in storage after the job has been printed.
