...
- Print jobs are encrypted in transit with TLS 1.2 or TLS 1.3. Queued jobs are stored temporarily in Microsoft 365 cloud storage and can remain for up to 10 days total; the 10-day window starts at job submission, and any unelapsed time is not reset after the job is printed.
