...
- Print jobs are encrypted in transit with TLS 1.2 or TLS 1.3. Queued jobs are stored temporarily in Microsoft 365 cloud storage for up to 10 days from submission, regardless of whether the job has already been printed.
